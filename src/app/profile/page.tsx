// src/app/profile/page.tsx - UNIVERSAL PROFILE FOR ALL ROLES
'use client';
...
import { User, Mail, Phone, MapPin, Save, Edit2, Car, Star } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="border-t pt-6">
                  <h3 className="text-lg font-bold mb-4">
                    {session?.user.role === 'customer' ? 'Delivery Address' : 'Your Address'}
                  </h3>
